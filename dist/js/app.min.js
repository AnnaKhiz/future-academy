...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _modules_back_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/back.js */ \"./src/js/modules/back.js\");\n/* harmony import */ var _modules_address_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/address-menu.js */ \"./src/js/modules/address-menu.js\");\n/* harmony import */ var _modules_index_play_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/index-play.js */ \"./src/js/modules/index-play.js\");\n/* harmony import */ var _modules_swiper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/swiper.js */ \"./src/js/modules/swiper.js\");\n/* harmony import */ var _modules_burger_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/burger.js */ \"./src/js/modules/burger.js\");\n/* harmony import */ var _modules_range_slider_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/range-slider.js */ \"./src/js/modules/range-slider.js\");\n/* harmony import */ var _modules_aside_menu_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/aside-menu.js */ \"./src/js/modules/aside-menu.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n_modules_back_js__WEBPACK_IMPORTED_MODULE_1__.backToPortfolio();\r\n_modules_burger_js__WEBPACK_IMPORTED_MODULE_5__.callBurgerMenu();\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n_modules_address_menu_js__WEBPACK_IMPORTED_MODULE_2__.callAddressMenu();\r\n_modules_address_menu_js__WEBPACK_IMPORTED_MODULE_2__.styleActiveLink();\r\nif (document.getElementById('index-video-container')) {\r\n    _modules_index_play_js__WEBPACK_IMPORTED_MODULE_3__.hideLayers();\r\n}\r\n\r\nif (document.querySelector('.main__index-feedback-swiper')) {\r\n    _modules_swiper_js__WEBPACK_IMPORTED_MODULE_4__.swipeIndexSwiper();\r\n    _modules_swiper_js__WEBPACK_IMPORTED_MODULE_4__.dragPosition();\r\n    _modules_swiper_js__WEBPACK_IMPORTED_MODULE_4__.setBgSize();\r\n    _modules_swiper_js__WEBPACK_IMPORTED_MODULE_4__.dragPositionTeam();\r\n}\r\n\r\nif (document.getElementById('slider')) {\r\n    _modules_range_slider_js__WEBPACK_IMPORTED_MODULE_6__.rangeSlider();\r\n}\r\nif (document.getElementById('aside-block')) {\r\n    _modules_aside_menu_js__WEBPACK_IMPORTED_MODULE_7__.toggleAsideMenu();\r\n}\r\n\r\n\r\n\r\n\r\n\r\n/*\r\nimport Swiper, { Navigation, Pagination } from 'swiper';\r\nconst swiper = new Swiper();\r\n*/\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");

/***/ }),

/***/ "./src/js/modules/address-menu.js":
/*!****************************************!*\
  !*** ./src/js/modules/address-menu.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   callAddressMenu: () => (/* binding */ callAddressMenu),\n/* harmony export */   styleActiveLink: () => (/* binding */ styleActiveLink)\n/* harmony export */ });\nfunction callAddressMenu() {\r\n    const addressBtn = [...document.querySelectorAll('[data-header-link=\"address\"]')];\r\n    const submenuHeader = [...document.querySelectorAll('[data-city-list=\"submenu-header\"]')];\r\n    const closeLink = [...document.querySelectorAll('[data-close-link=\"header-block-sub-close\"]')];\r\n    const contactsLink = document.querySelector('.header-block__container-contacts-link');\r\n    const allCoursesLink = document.querySelector('.header-block__container-all-courses');\r\n\r\n    function showHideMenu (button) {\r\n        button.addEventListener('click', (event) => {\r\n            event.preventDefault();\r\n            submenuHeader.forEach((e) => {\r\n                e.classList.toggle('hidden');\r\n            });\r\n            contactsLink.classList.toggle('colored-line');\r\n\r\n        });\r\n    }\r\n\r\n    addressBtn.forEach((e) => {\r\n        showHideMenu(e)\r\n    });\r\n\r\n    closeLink.forEach((e) => {\r\n        showHideMenu(e)\r\n    });\r\n}\r\n\r\n\r\nfunction styleActiveLink() {\r\n    document.addEventListener('DOMContentLoaded', (event) => {\r\n        const address = [...document.querySelectorAll('[data-menu-link]')]\r\n                        .map(element => element.dataset.menuLink);\r\n        address.forEach((link) => {\r\n            if (window.location.toString().includes(link)) {\r\n                const headerLinksEl = document.querySelector(`[data-menu-link=\"${link}\"]`);\r\n                headerLinksEl.classList.add('colored-line')\r\n            }\r\n        })\r\n    })\r\n}\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/address-menu.js?");

/***/ }),

/***/ "./src/js/modules/aside-menu.js":
/*!**************************************!*\
  !*** ./src/js/modules/aside-menu.js ***!
  \**************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   toggleAsideMenu: () => (/* binding */ toggleAsideMenu)\n/* harmony export */ });\nfunction toggleAsideMenu() {\r\n    const asideMenuButton = document.getElementById('aside-menu-button');\r\n    const asideBlock = document.getElementById('aside-block');\r\n\r\n    if (window.screen.width <= 1090) {\r\n        asideBlock.classList.add('hidden');\r\n        asideMenuButton.classList.remove('hidden');\r\n        asideMenuButton.addEventListener('click', (event) => {\r\n            event.preventDefault();\r\n            asideBlock.classList.toggle('hidden');\r\n        });\r\n    }\r\n}\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/aside-menu.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   backToPortfolio: () => (/* binding */ backToPortfolio)\n/* harmony export */ });\nfunction backToPortfolio() {\r\n  const backButton = document.getElementById('button-back');\r\n  backButton.addEventListener('click', () => {\r\n    location.replace('https://anna-khizhniak.site/')\r\n  })\r\n}\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/back.js?");
